...
public class Goblin extends Ai {
	...
	//simply change the name of the constructors and these base values to your specifications
	//the constructors will work if you have a target to add or not but the world builder does defaults to adding the player as a target;
	//the stats scale with levels and the constructors default to level 1 if a level is not provided
