...
public WorldFrame(World<T> world) {
    ...
    gridClasses = new TreeSet<Class>(new Comparator<Class>() {
        ...
        public <T, U extends Comparable<? super U>> Comparator<T> comparing(Function<? super T, ? extends U> arg0) {
            return null;
        }
        
        public <T, U> Comparator<T> comparing(Function<? super T, ? extends U> arg0, Comparator<? super U> arg1) {
            return null;
        }
        
        public <T> Comparator<T> comparingDouble(ToDoubleFunction<? super T> arg0) {
            return null;
        }
        
        public <T> Comparator<T> comparingInt(ToIntFunction<? super T> arg0) {
            return null;
        }
        
        public <T> Comparator<T> comparingLong(ToLongFunction<? super T> arg0) {
            return null;
        }
        ...
        @Override
        public Comparator<Class> reversed() {
            return null;
        }
        
        @Override
        public Comparator<Class> thenComparing(Comparator<? super Class> arg0) {
            return null;
        }
        
        @Override
        public <U extends Comparable<? super U>> Comparator<Class> thenComparing(Function<? super Class, ? extends U> arg0) {
            return null;
        }
        
        @Override
        public <U> Comparator<Class> thenComparing(Function<? super Class, ? extends U> arg0, Comparator<? super U> arg1) {
            return null;
        }
        
        @Override
        public Comparator<Class> thenComparingDouble(ToDoubleFunction<? super Class> arg0) {
            return null;
        }
        
        @Override
        public Comparator<Class> thenComparingInt(ToIntFunction<? super Class> arg0) {
            return null;
        }
        
        @Override
        public Comparator<Class> thenComparingLong(ToLongFunction<? super Class> arg0) {
            return null;
        }
    });
...
public void handle(Throwable e) {
    ...
    JOptionPane pane = new JOptionPane(new JScrollPane(area), JOptionPane.ERROR_MESSAGE, JOptionPane.YES_NO_OPTION, null, new String[] { copyOption, resources.getString("cancel") });
